...
Этот репозиторий посвящен одной из частей проекта по разработке сметной подсистемы.
Для понимания контекста добавил описание проекта.

### Термины
- Работа - это буквально "Вид работ" соответствующий справочникам ГЭСН и прочим, описывающий деятельность людей (например - транспортировка материала)
- Материал - некоторый ресурс (от воды до кирпичей)
- Техника - Техника :)
- ГрандСмета - система для автоматизации определения сметной стоимости строительства и учета выполненных работ.
- БИТ.Строительство - конфигурация для застройщиков на базе БИТ.Финанс (в свою очередь на базе Бухгалтерии), выступающая в качестве замены ERP: УСО
## Контекст проекта
...
## Часть требований из ТЗ в качестве примера
...
-   Ручной ввод этажей + автозаполнение по разделу/виду работ.
...
-   Материалы заказчика должны определяться и выделяться
- 	Смета загружается из XML-документа ГрандСметы     
...
** - разработано мной полностью. Остальное - только частично.
